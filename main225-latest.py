...
# Inisiasi Ubidots
VARIABLE_ID = "64f042ac5e11532ace847852"
UBIDOTS_URL = f"https://industrial.api.ubidots.com/api/v1.6/variables/{VARIABLE_ID}/values/"
UBIDOTS_TOKEN = "BBFF-KAlGMhCluOXPpfWTxwy9x1JIjiEusO"
...
def send_to_telegram(photo_path):
    ...
    bot.sendMessage(chat_id, 'Hey ada maling loh!')
...
def beep():
    ...
    time.sleep(3)  # Ubah durasi bunyi sesuai kebutuhan
    ...
    while True:
        ...
        if is_authenticated is not None:
            if not is_authenticated:
                ...
                lcd_string("SALAH COBA LAGI", LCD_LINE_1)
                ...
                lcd_string("BERHASIL SILAHKAN MASUK", LCD_LINE_1)
                control_solenoid("UNLOCK")
                time.sleep(5)
                control_solenoid("LOCK")        
